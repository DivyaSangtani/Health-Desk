...
<form action="/action_page.php" style="border:1px solid #ccc">
  <div class="container">
<div style='color:#1430EA' align='center'><h2>Donate Blood</h2></div>
...
<label for="bgname"><b>Blood Group</b></label>
   <input type="text" placeholder="Enter Blood Group Required" name="bgname" required>
...
<input type="radio" id="male" name="gender" value="male">
 ...
 <div class="clearfix">
      ...
      <button type="submit" class="submitbtn">Post Request</button>
    </div>
</div>
</form>
